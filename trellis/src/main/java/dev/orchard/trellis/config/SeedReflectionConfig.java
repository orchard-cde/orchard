...
@RegisterReflectionForBinding({
    ...
    DevcontainerSeed.PortAttributes.class,
    DevcontainerSeed.UserEnvProbe.class,
    DevcontainerSeed.HostRequirements.class,
    DevcontainerSeed.SecretDeclaration.class,
    DevfileSeed.class,
